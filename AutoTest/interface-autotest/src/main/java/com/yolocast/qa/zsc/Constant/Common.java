...
public class Common {
    ...
    static {
        try {
            InputStream in = Common.class.getClassLoader().getResourceAsStream("application.properties");
    ...
    public static String yolocastUrl = STATIC_PROPERTIES.getProperty("yolocast.prod.url");//不同环境切换不同域名就好 生产环境：yolocast.prod.url 测试环境：yolocast.test.url
